...
class MultiMLPSAGESep(GeneralMultiMLPModel):
    def __init__(
        self,
        run_config,
        input_size,
        ...
        super(MultiMLPSAGESep, self).__init__(run_config, input_size, output_size, device, rng, eps, num_hidden, model_name)
...
if __name__ == "__main__":
    ...
    model = MultiMLPSAGESep(RunConfig(), 10, 2, torch.rand(10, 10), "cpu", np.random)
    print(model)
