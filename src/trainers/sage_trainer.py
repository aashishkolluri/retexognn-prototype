...
from models.hetero_sage import GraphSAGESep
from torch_geometric.loader import NeighborLoader


def train_sage_on_dataset(
    run_config,
    ...
    print(
        "Training graphSAGE dataset={}, test_dataset={}".format(
    ...
    for i in range(len(seeds)):
        ...
        if run_config.parse_communication_results:
            utils.parse_communication_gnn(model, 'mmlp_sage_nl_2', dataset)
            return
